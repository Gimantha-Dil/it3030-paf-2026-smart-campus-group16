            ...
            <div>
              ...
              <div className="relative">
                <input type={showPw.current ? 'text' : 'password'} value={currentPw} onChange={e => setCurrentPw(e.target.value)}
                  placeholder="••••••••"
                  className="w-full px-3 py-2.5 pr-10 border dark:border-gray-600 rounded-lg text-sm outline-none focus:ring-2 focus:ring-primary-400 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100" />
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPw.confirm ? 'text' : 'password'} value={confirmPw} onChange={e => setConfirmPw(e.target.value)}
                  placeholder="••••••••"
                  className={`w-full px-3 py-2.5 pr-10 border rounded-lg text-sm outline-none focus:ring-2 focus:ring-primary-400 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 ${
